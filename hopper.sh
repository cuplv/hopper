...
<<<<<<< HEAD
scala210 -cp "$CLASSPATH" -J-Xmx8g edu.colorado.scwala.translate.Main $@
=======
scala210 -cp "$CLASSPATH" edu.colorado.scwala.translate.Main $@
>>>>>>> 07ccf5b... Improved hopper.sh that allows running without SBT, improved gitignore
